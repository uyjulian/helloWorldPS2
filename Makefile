...
EE_OBJS = pad.o iomanX_irx.o filexio_irx.o usbd_irx.o bdm_irx.o bdmfs_fatfs_irx.o usbmass_bd_irx.o ps2mouse_irx.o
EE_LIBS = -lpad -lmouse -lc -ldebug -lpatches -lfileXio
