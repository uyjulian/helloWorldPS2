    ...
    for (;;) {      // We are phorever people
        ...
        if (ret != 0) {
            ...
            if(new_pad & PAD_LEFT) {
...
#endif
                struct stat xstatw;
                open("/hoge1.txt", O_RDONLY);
                open("\\hoge1.txt", O_RDONLY);
                open("hoge1.txt", O_RDONLY);
                open("/hogex/hoge2.txt", O_RDONLY);
                open("\\hogex\\hoge2.txt", O_RDONLY);
                open("/hogex/hoge2.txt", O_RDONLY);
                open("././/hoge1.txt", O_RDONLY);
                open("././\\hoge1.txt", O_RDONLY);
                ...
                open("./../\\hogex\\hoge2.txt", O_RDONLY);
                open("./..//hogex/hoge2.txt", O_RDONLY);
                open("cdrom:/hoge1.txt", O_RDONLY);
                open("cdrom:\\hoge1.txt", O_RDONLY);
                open("cdrom:hoge1.txt", O_RDONLY);
                open("cdrom:/hogex/hoge2.txt", O_RDONLY);
                open("cdrom:\\hogex\\hoge2.txt", O_RDONLY);
                open("cdrom:/hogex/hoge2.txt", O_RDONLY);
                open("cdrom0:/hoge1.txt", O_RDONLY);
                open("cdrom0:\\hoge1.txt", O_RDONLY);
                open("cdrom0:hoge1.txt", O_RDONLY);
                open("cdrom0:/hogex/hoge2.txt", O_RDONLY);
                open("cdrom0:\\hogex\\hoge2.txt", O_RDONLY);
                open("cdrom0:/hogex/hoge2.txt", O_RDONLY);
                open("mc:/hoge1.txt", O_RDONLY);
                open("mc:\\hoge1.txt", O_RDONLY);
                open("mc:hoge1.txt", O_RDONLY);
                open("mc:/hogex/hoge2.txt", O_RDONLY);
                open("mc:\\hogex\\hoge2.txt", O_RDONLY);
                open("mc:/hogex/hoge2.txt", O_RDONLY);
                open("mc0:/hoge1.txt", O_RDONLY);
                open("mc0:\\hoge1.txt", O_RDONLY);
                open("mc0:hoge1.txt", O_RDONLY);
                open("mc0:/hogex/hoge2.txt", O_RDONLY);
                open("mc0:\\hogex\\hoge2.txt", O_RDONLY);
                open("mc0:/hogex/hoge2.txt", O_RDONLY);
                open("mass:/hoge1.txt", O_RDONLY);
                open("mass:\\hoge1.txt", O_RDONLY);
                open("mass:hoge1.txt", O_RDONLY);
                open("mass:/hogex/hoge2.txt", O_RDONLY);
                open("mass:\\hogex\\hoge2.txt", O_RDONLY);
                open("mass:/hogex/hoge2.txt", O_RDONLY);
                open("mass0:/hoge1.txt", O_RDONLY);
                open("mass0:\\hoge1.txt", O_RDONLY);
                open("mass0:hoge1.txt", O_RDONLY);
                open("mass0:/hogex/hoge2.txt", O_RDONLY);
                open("mass0:\\hogex\\hoge2.txt", O_RDONLY);
                open("mass0:/hogex/hoge2.txt", O_RDONLY);
                open("rom:/hoge1.txt", O_RDONLY);
                open("rom:\\hoge1.txt", O_RDONLY);
                open("rom:hoge1.txt", O_RDONLY);
                open("rom:/hogex/hoge2.txt", O_RDONLY);
                open("rom:\\hogex\\hoge2.txt", O_RDONLY);
                open("rom:/hogex/hoge2.txt", O_RDONLY);
                open("rom0:/hoge1.txt", O_RDONLY);
                open("rom0:\\hoge1.txt", O_RDONLY);
                open("rom0:hoge1.txt", O_RDONLY);
                open("rom0:/hogex/hoge2.txt", O_RDONLY);
                open("rom0:\\hogex\\hoge2.txt", O_RDONLY);
                open("rom0:/hogex/hoge2.txt", O_RDONLY);
                open("host:/hoge1.txt", O_RDONLY);
                open("host:\\hoge1.txt", O_RDONLY);
                open("host:hoge1.txt", O_RDONLY);
                open("host:/hogex/hoge2.txt", O_RDONLY);
                open("host:\\hogex\\hoge2.txt", O_RDONLY);
                open("host:/hogex/hoge2.txt", O_RDONLY);
                open("host0:/hoge1.txt", O_RDONLY);
                open("host0:\\hoge1.txt", O_RDONLY);
                open("host0:hoge1.txt", O_RDONLY);
                open("host0:/hogex/hoge2.txt", O_RDONLY);
                open("host0:\\hogex\\hoge2.txt", O_RDONLY);
                open("host0:/hogex/hoge2.txt", O_RDONLY);
                open("host:D:\\/hoge1.txt", O_RDONLY);
                open("host:D:\\\\hoge1.txt", O_RDONLY);
                open("host:D:\\hoge1.txt", O_RDONLY);
                open("host:D:\\/hogex/hoge2.txt", O_RDONLY);
                open("host:D:\\\\hogex\\hoge2.txt", O_RDONLY);
                open("host:D:\\/hogex/hoge2.txt", O_RDONLY);
                open("host0:D:\\/hoge1.txt", O_RDONLY);
                open("host0:D:\\\\hoge1.txt", O_RDONLY);
                open("host0:D:\\hoge1.txt", O_RDONLY);
                open("host0:D:\\/hogex/hoge2.txt", O_RDONLY);
                open("host0:D:\\\\hogex\\hoge2.txt", O_RDONLY);
                open("host0:D:\\/hogex/hoge2.txt", O_RDONLY);
