        ...
        if (ret != 0) {
            ...
            if(new_pad & PAD_DOWN) {
...

                {
                    ...
                    int fd = fileXioOpen("host:/Users/julian/Documents/ps2src/uyjulian/mcman_test/pad_example.elf", FIO_O_RDONLY);
                    if (fd >= 0)
                    {
                    ...
                    if (fd >= 0)
                    {
                        ...
                        fd = fileXioOpen("host:/Users/julian/Documents/ps2src/uyjulian/mcman_test/pad_example_fixme.elf", FIO_O_WRONLY | FIO_O_CREAT);
                        if (fd >= 0)
                        {
                            fileXioWrite(fd, string, fsize);
                            fileXioClose(fd);
