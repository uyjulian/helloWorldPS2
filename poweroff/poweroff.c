...
void mymodule_proc_Thread(void* param)
{
	(void)param;
...
int bss_random1[0x400];
int bss_random2[0x400];
const char *strX = "HithereXn";
char *strY = "HithereYn";
int static_int_1 = 0x11111111;
int static_int_2 = 0x22222222;
...
#if 0
	printf("Hello world!\n");
	printf("BSS pointer 1 %p %x\n", bss_random1, sizeof(bss_random1));
	printf("BSS pointer 2 %p %x\n", bss_random2, sizeof(bss_random2));
	printf("str pointer 1 %p %x\n", strX, sizeof(strX));
	printf("str         1 %s\n", strX);
	printf("str pointer 2 %p %x\n", strY, sizeof(strY));
	printf("str         2 %s\n", strY);
	printf("int pointer 1 %p %x\n", &static_int_1, sizeof(static_int_1));
	printf("int         1 %x\n", static_int_1);
	printf("int pointer 2 %p %x\n", &static_int_2, sizeof(static_int_2));
	printf("int         2 %x\n", static_int_2);
#endif
	iop_thread_t mythread;
	mythread.attr = TH_C;
	mythread.option = 0;
	mythread.thread = mymodule_proc_Thread;
	mythread.stacksize = 0x1000;
	mythread.priority = 0x18;
